...
try:
    ...
    _import_structure["pipeline_cogvideox_vividvr"] = ["CogVideoXVividVRControlNetPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_cogvideox_vividvr import CogVideoXVividVRControlNetPipeline
